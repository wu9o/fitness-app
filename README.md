...
- Flutter 主应用：已具备 MapLibre/OpenFreeMap 地图、可折叠运动控制、本地运动记录、运动结束总结、GPS 采样质量、路线触觉提醒、HealthKit 设备运动与心率曲线导入、个性化心率 5 区、校验恢复快照、记录来源筛选、28 天负荷趋势、睡眠详情、训练计划模板和路线保存/跟随流程
