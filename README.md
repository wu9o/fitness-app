...
- Release assets are development previews: a development-signed Android Release APK, an iOS Simulator Debug bundle, and an unsigned macOS Release app. They are not App Store or Play Store packages.
