...
- HealthKit 关联心率采样支持增量同步、详情曲线和固定 bpm 分布；全部记录支持运动类型与来源筛选
...
1. iPhone/iPad：HealthKit 健康快照和设备运动导入已接入，下一步在真机验证 Apple Watch 来源与权限矩阵
2. iPhone：后台运动定位与锁屏持续记录已接入，下一步补真机功耗、系统回收和长时间稳定性验证
3. 分段配速、主观负荷、HealthKit 心率曲线和活动能量已接入；下一步增加用户最大心率配置，再升级为个体化心率区间
